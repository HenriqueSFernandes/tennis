  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 max-w-3xl mx-auto">
      ...
      <section className="space-y-3">
        ...
        <label className="flex items-center gap-3 bg-slate-800 rounded-xl p-4 border border-slate-700/50 cursor-pointer">
          <input
            type="checkbox"
            checked={profile?.showBookingsToFriends ?? false}
